  ...
  return (
    ...
    >
      <div className="container">
        <div className="footer-grid" style={{ marginBottom: "3rem" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "0.75rem" }}>
              {[{ label: "TG", href: "#" }, { label: "VK", href: "#" }, { label: "YT", href: "#" }].map((s) => (
                <a
                  key={s.label}
                  href={s.href}
                  style={{
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(143,245,255,0.12)"; e.currentTarget.style.color = "#8ff5ff"; }}
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <p className="label-caps" style={{ color: "#494847", marginBottom: "1.25rem", fontSize: "0.65rem" }}>
                {category}
              </p>
              <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                {links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      style={{ fontSize: "0.85rem", color: "#adaaaa", textDecoration: "none", transition: "color 0.2s" }}
        ...
        <div
          style={{
            borderTop: "1px solid rgba(73,72,71,0.15)", paddingTop: "1.5rem",
